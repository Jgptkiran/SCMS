...
<head>
    ...
    <title>Lawn Tennis Booking</title>
...
<body>
    ...
    include 'header.php';
    ?>
    <h1>Lawn Tennis Booking Slots</h1>
    <form id="dateForm">
    ...
    <script>
       document.addEventListener('DOMContentLoaded', function() {
        ...
        const slotPrice = 10; // Price per 30-minute slot
    ...
    fetch(`tennis_get_booked_slots.php?date=${date}`)
        ...
        document.getElementById('continueButton').addEventListener('click', function() {
            ...
            window.location.href = `tennisbookingprocess.html?${queryString}`;
        });
    </script>
</body>
</html>
