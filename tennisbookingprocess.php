...
$facilityID = 4; // You can update this dynamically based on the facility selected
$location = "Lawn Tennis"; // Update dynamically as needed
$field = "Court 2"; // Update dynamically based on the slot booked
?>
<!DOCTYPE html>
<html lang="en">
<head>
