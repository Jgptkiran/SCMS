...
<body>
    ...
    fetch(`swimming_get_booked_slots.php?date=${date}`)
        ...
        document.getElementById('continueButton').addEventListener('click', function() {
            ...
            window.location.href = `swimmingbookingprocess.html?${queryString}`;
        });
    </script>
</body>
</html>
