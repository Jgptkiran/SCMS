...
$facilityID = 2; // You can update this dynamically based on the facility selected
$location = "futsal"; // Update dynamically as needed
$field = "field 1"; // Update dynamically based on the slot booked
?>
<!DOCTYPE html>
<html lang="en">
<head>
